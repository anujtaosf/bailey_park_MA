  ...
  return (
    <div className="report-container">
      <aside className="sidebar">
        ...
        <nav>
          <a href="#demographics">Neighborhood Demographics</a>
          <a href="#history">Neighborhood History</a>
          <a href="#developments">Current Developments</a>
          <a href="#quantitative">Quantitative Trends</a>
          <a href="#infrastructure">Infrastructure Trends</a>
          <a href="#properties">Properties on the Market</a>
        </nav>
      </aside>
